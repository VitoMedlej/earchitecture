  ...
  if (req.method === 'GET') {
    try {
        ...
        const info = await transporter.sendMail({
            from: '"EArchitecture" <info@earchitecture-lb.com>', // sender address
            ...
            <footer>
            <p>Contact us at: <a href="mailto:info@earchitecture-lb.com">info@earchitecture-lb.com</a></p>
